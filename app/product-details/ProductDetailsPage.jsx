        ...
        <div className="row align-items-start gy-4">
          ...
          >
            {width > 768 ? (
              <ImageZoomRight
                src={activeImg}
                zoomWidth={width > 1480 ? 600 : width > 1250 ? 500 : 400}
                zoomHeight={width > 1250 ? 500 : 400}
              />
            ) : (
              <Image
                src={activeImg}
          ...
          <div className="col-md-5">
            ...
            >
              ...
              <p className="text-muted mb-4">
                Experience the future of smart furniture with the Smart Bench
                Pro — built with durable materials, integrated charging ports,
                and a modern design for both comfort and functionality.
              </p>
              ...
              <div className="d-flex gap-3 mb-4">
                <Button
                  handleNavigate={() => setOpenForm(true)}
                ...
                {openForm && (
                  <MainPortal handleCloseModal={() => setOpenForm(false)}>
                    <RequestForm
          ...
          <div className="d-flex flex-wrap gap-3 mb-4 justify-content-center">
            {infoCards.map((card) => (
              <Button
                ...
                className={`btn onHover px-4 py-2 text-dark rounded-pill fw-semibold shadow-sm ${
                  activeTab === card.id
